...
まずは、プロジェクトの立ち上げ時に、そのシステムを希望する理由（Why）を顧客に確認しましょう。どのようなビジネス上の課題がもとであなたに相談しているのか、背景を確認しましょう。顧客のビジネスを理解する手段として、顧客の会社ホームページは有効です。最新ニュースや会社の理念、IR情報などヒントになる情報がたくさんあります。一度は覗いてみましょう。
